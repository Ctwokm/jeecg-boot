...
public class MsgPushEntity {
    ...
    public String getMsgRedirectUrl() {
        return msgRedirectUrl;
    }

    public void setMsgRedirectUrl(String msgRedirectUrl) {
        this.msgRedirectUrl = msgRedirectUrl;
    }
