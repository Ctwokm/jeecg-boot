 ...
 * @Auther: Suyb
 * @Date: 2021/3/16
 * @Description: 化验室相关功能的后台controller入口
 */
@RestController
@Api(tags = "化验业务管理")
@RequestMapping("/znrl/labory")
@Slf4j
...
//    为都匀单独使用 by xxs
    ...
    *//**
    ...
    @ResponseBody
    public Result qryLabDataUploadCfgByUsage(@PathVariable String usage){
        LabDataUploadEntity labDataUploadEntity = new LabDataUploadEntity();
        labDataUploadEntity.setUsage(usage);
       List<LabDataUploadEntity> list = new ArrayList<>();
        try {
            list = laboryService.qryLabDataUploadCfg(labDataUploadEntity);
        } catch (Exception e) {
            e.printStackTrace();
        }
        Result r  = new Result();
    ...
    @ResponseBody
    public Result qryLabDataUploadCfg(){
        LabDataUploadEntity labDataUploadEntity = new LabDataUploadEntity();
        List<LabDataUploadEntity> list = new ArrayList<>();
        try {
            list = laboryService.qryLabDataUploadCfg(labDataUploadEntity);
   ...
   @RequestMapping(value="/uploadLabData")
    @ResponseBody
    @Transactional
    public Result uploadLabData(LabDataUploadEntity labDataUploadEntity){
        Result result = new Result();
        try {
            ...
            if (labDataUploadEntity.getResCode() != null && labDataUploadEntity.getResCode().equals("0")) {
                //result.setResult("0");
                result.setCode(1);
               // result.setMessage("数据上传完成");
            } else {

              //  result.setResult("数据上传未完成:"+labDataUploadEntity.getResMsg());
                result.setCode(1);
                result.setMessage("数据上传未完成:"+labDataUploadEntity.getResMsg());
                //result.setSuccessful(false);
            }

        } catch (ConnectException e) {
            result.setResult("网络连接异常，请检查化验室电脑及上传服务是否已经开启！");
            //result.setSuccessful(false);
            e.printStackTrace();
        } catch (Exception e) {
            result.setResult("发生异常:"+e.getMessage());
           //result.setSuccessful(false);
            e.printStackTrace();
        }
    ...
    @RequestMapping(value="/qryScalesResOrgData")
    @ResponseBody
    public Result qryScalesResOrgData(ScalesEntity scalesEntity){
       Result r = new Result();
        //ScalesEntity scalesEntity = SearchForm(ScalesEntity.class);
       ...
       // scalesEntity.setOpCode(opCode);
        ...
        List<ScalesEntity> list = new ArrayList<>();
        try {
            list = laboryService.qryScalesResOrgData(scalesEntity);
        } catch (Exception e) {
            e.printStackTrace();
        }
         r.setResult(list);
    ...
    @RequestMapping(value="/qrySResOrgData")
    @ResponseBody
    public Result qrySResOrgData(SEntity sEntity){
        //SEntity sEntity = SearchForm(SEntity.class);
       ...
       // GridModel gridModel = null;
        ...
        try {
            list = laboryService.qrySResOrgData(sEntity);
        } catch (Exception e) {
            e.printStackTrace();
        }
        r.setResult(list);
    ...
    @RequestMapping(value="/qryIAResOrgData")
    @ResponseBody
    public Result qryIAResOrgData(IndstAnalyEntity indstAnalyEntity){
       /* IndstAnalyEntity indstAnalyEntity = SearchForm(IndstAnalyEntity.class);
        ...
        GridModel gridModel = null;*/
        Result r = new Result();
        List<IndstAnalyEntity> list = new ArrayList<>();
        try {
            list = laboryService.qryIAResOrgData(indstAnalyEntity);
        } catch (Exception e) {
            e.printStackTrace();
        }
        r.setResult(list);
    ...
    @RequestMapping(value="/qryHotResOrgData")
    @ResponseBody
    public Result qryHotResOrgData(HotEntity hotEntity){
       /* HotEntity hotEntity = SearchForm(HotEntity.class);
       ...
       // GridModel gridModel = null;
        ...
        try {
            list = laboryService.qryHotResOrgData(hotEntity);
        } catch (Exception e) {
            e.printStackTrace();
        }
        r.setResult(list);
    ...
    @RequestMapping(value="/qryLaResOrgData")
    @ResponseBody
    public Result qryLaResOrgData(LightAnalyEntity lightAnalyEntity){
       /* LightAnalyEntity lightAnalyEntity = SearchForm(LightAnalyEntity.class);
        ...
        Result r = new Result();
        List<LightAnalyEntity> list = new ArrayList<>();
        try {
            list = laboryService.qryLaResOrgData(lightAnalyEntity);
        } catch (Exception e) {
            e.printStackTrace();
        }
        r.setResult(list);
    ...
    @RequestMapping(value="/qryHwResOrgData")
    @ResponseBody
    public Result qryHwResOrgData(HEntity hEntity){
        /*HEntity hEntity = SearchForm(HEntity.class);
        ...
        Result r = new Result();
        List<HEntity> list = new ArrayList<>();
        try {
            list = laboryService.qryHwResOrgData(hEntity);
        } catch (Exception e) {
            e.printStackTrace();
        }
        r.setResult(list);
        ...
        try {
          ...
          //  String updateCode = shiroUser.getUser().getId().toString();
           // sEntity.setUpdateCode(updateCode);
            ...
            if (sEntity.getResCode() != null && sEntity.getResCode().equals("0")) {
                result.setCode(0);
                result.setMessage("化验数据失效成功!");
                result.setSuccess(true);
            } else {
                result.setCode(1);
                result.setMessage("化验数据失效失败:"+sEntity.getResMsg());
               result.setSuccess(false);
            }
        } catch (Exception e) {
            result.setCode(2);
            result.setMessage("化验数据失效异常:"+e.getMessage());
            result.setSuccess(false);
            e.printStackTrace();
        }
        return result;
        ...
        try {
           ...
           // String opCode = shiroUser.getUser().getId().toString();
            ...
            if (scalesEntity.getResCode() != null && scalesEntity.getResCode().equals("0")) {
                ...
                result.setMessage("批量确认失败:"+scalesEntity.getResMsg());
                result.setSuccess(false);
            }
        } catch (Exception e) {
            result.setMessage("批量确认异常:"+e.getMessage());
            result.setSuccess(false);
            e.printStackTrace();
        }
        return result;
    ...
    @RequestMapping(value="/qryScalesResData")
    @ResponseBody
    public Result qryScalesResData(ScalesEntity scalesEntity){

        List<ScalesEntity>   list = new ArrayList<>();
        Result r = new Result();
        try {
            list = laboryService.qryScalesResData(scalesEntity);
        } catch (Exception e) {
            e.printStackTrace();
        }
        r.setResult(list);
    ...
    @RequestMapping(value="/qrySResData")
    @ResponseBody
    public Result qrySResData(SEntity sEntity){

        List<SEntity>   list = new ArrayList<>();
        Result r = new Result();
        try {
            list = laboryService.qrySResData(sEntity);
        } catch (Exception e) {
            e.printStackTrace();
        }
        r.setResult(list);
    ...
    @RequestMapping(value="/qryIAResData")
    @ResponseBody
    public Result qryIAResData(IndstAnalyEntity indstAnalyEntity){
      List<IndstAnalyEntity>   list = new ArrayList<>();
        Result r = new Result();

        try {
            list = laboryService.qryIAResData(indstAnalyEntity);
        } catch (Exception e) {
            e.printStackTrace();
        }
        r.setResult(list);
    ...
    @RequestMapping(value="/qryHotResData")
    @ResponseBody
    public Result qryHotResData(HotEntity hotEntity){

        List<HotEntity>   list = new ArrayList<>();
        Result r = new Result();
        try {
            list = laboryService.qryHotResData(hotEntity);
        } catch (Exception e) {
            e.printStackTrace();
        }
        r.setResult(list);
    ...
    @RequestMapping(value="/qryLaResData")
    @ResponseBody
    public Result qryLaResData(LightAnalyEntity lightAnalyEntity){

        List<LightAnalyEntity>   list = new ArrayList<>();
        Result r = new Result();
        try {
            list = laboryService.qryLaResData(lightAnalyEntity);
        } catch (Exception e) {
            e.printStackTrace();
        }
        r.setResult(list);
    ...
    @RequestMapping(value="/qryHwResData")
    @ResponseBody
    public Result qryHwResData(HEntity hEntity){

        List<HEntity>   list = new ArrayList<>();
        Result r = new Result();
        try {
            list = laboryService.qryHwResData(hEntity);
        } catch (Exception e) {
            e.printStackTrace();
        }
        r.setResult(list);
    ...
    @ResponseBody
    @Transactional
    public Result submit4LabReport(SEntity sEntity){
        Result result = new Result();
        ...
        try {
            ...
            if (sEntity.getResCode() != null && sEntity.getResCode().equals("0")) {
                ...
                result.setMessage("操作失败:"+sEntity.getResMsg());
                result.setSuccess(false);
            }
        } catch (Exception e) {
    ...
    /**
     * @Author Hujw
     * @Description //TODO 加了个分页插件，防止数据被全查，封装类继承一下分页类既可以了。
     * @Date 14:16 2021/3/18
     * @Param
     * @return
     **/
    @RequestMapping(value="/qryReportData")
    @ResponseBody
    public Result qryReportData(ReportEntity reportEntity){


        Result r = new Result();

        Page<ReportEntity> pageList = new Page<ReportEntity>(reportEntity.getPageNo(), reportEntity.getPageSize());

        List<ReportEntity> list  = new ArrayList<>();
        try {
            pageList = laboryService.qryReportData(pageList,reportEntity);
//            list = laboryService.qryReportData(reportEntity);
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    @ResponseBody
    @Transactional
    public Result submitLabResults(SEntity sEntity){
        Result result = new Result();
    ...
    @ResponseBody
    public Result qryManInfo(ManualSampleEntity manualSampleEntity) {
        // ManualSampleEntity manualSampleEntity = SearchForm(ManualSampleEntity.class);
        List<ManualSampleEntity> list = new ArrayList<>();
        try {
            list = laboryService.qryManInfo(manualSampleEntity);
        } catch (Exception e) {
            e.printStackTrace();
        }
        Result r  = new Result();
