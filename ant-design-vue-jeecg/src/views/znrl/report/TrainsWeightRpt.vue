...
<script>
  ...
  export default {
    name: 'TrainsWeightRpt',
    //  mixins:[JeecgListMixin, mixinDevice],
    data () {
      return {
        description: '汽车计量报表',
        queryParam: {
          beginTime:moment().subtract('month',1).format('YYYY-MM-DD'),
        ...
        // 表头
        url: {
          list: "http://localhost:8088/jeecg-boot/ureport/preview?_u=file:trainsWeightRpt_daily.ureport.xml",
          ureportlist:"",
          totalResultlist:"/znrl/report/trainWeightSummaryRpt"
