          ...
          <a-col :md="6" :sm="10">
            <span style="float: left;overflow: hidden;" class="table-page-search-submitButtons">
              &nbsp;
               ...
               <a-button type="primary" @click="handleEditGF" icon="danger">确认无效</a-button>
               <a-button type="primary" @click="handleAddGF" icon="primary">批量确认</a-button>
...
export default {
  ...
  data () {
    return {
      ...
      url: {
        list: "/znrl/labory/qryIAResOrgData",
