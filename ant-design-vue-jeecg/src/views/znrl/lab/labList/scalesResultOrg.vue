          ...
          <a-col :md="5" :sm="10">
            <span style="float: left;overflow: hidden;" class="table-page-search-submitButtons">
              &nbsp;
               ...
               <a-button type="primary" @click="handleEditTP" icon="danger">确认无效</a-button>
               <a-button type="primary" @click="handleAddTP" icon="primary">批量确认</a-button>
...
export default {
  ...
  data () {
    return {
      ...
      url: {
        list: "/znrl/labory/qryScalesResOrgData",
        ...
        deleteScalesUrl:"/znrl/labory/deleteLabData/S",
        addScalesUrl:"/znrl/labory/lotAddSubmit/S",
