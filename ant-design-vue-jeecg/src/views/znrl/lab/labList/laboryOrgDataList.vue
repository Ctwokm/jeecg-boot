   ...
   <!-- <div>
    ...
    <a-tabs defaultActiveKey="1">
      ...
      <a-tab-pane tab="机票信息" key="2" forceRender>
        ...
        <a-tab-pane tab="化验天平" key="1" forceRender>
          <scales-result-org ref="scales-result-org"></scales-result-org>
        </a-tab-pane>

        <a-tab-pane tab="定硫仪" key="2" forceRender>
          <s-result-org ref="s-result-org"></s-result-org>
        </a-tab-pane>

        <a-tab-pane tab="工业分析仪" key="3" forceRender>
          <indst-analy-result-org ref="indst-analy-result-org"></indst-analy-result-org>
        </a-tab-pane>

        <a-tab-pane tab="量热仪" key="4" forceRender>
          <hot-result-org ref="hot-result-org"></hot-result-org>
        </a-tab-pane>

        <a-tab-pane tab="光波分析仪" key="5" forceRender>
          <light-analy-result-org ref="light-analy-result-org"></light-analy-result-org>
        </a-tab-pane>

        <a-tab-pane tab="红外测氢仪" key="6" forceRender>
          <h-result-org ref="h-result-org"></h-result-org>
        </a-tab-pane>
    </a-tabs>
...
import HotResultOrg from '@views/znrl/lab/labList/hotResultOrg'
import SResultOrg from '@views/znrl/lab/labList/sResultOrg'
import ScalesResultOrg from '@views/znrl/lab/labList/scalesResultOrg'
import IndstAnalyResultOrg from '@views/znrl/lab/labList/indstAnalyResultOrg'
import LightAnalyResultOrg from '@views/znrl/lab/labList/lightAnalyResultOrg'
import HResultOrg from '@views/znrl/lab/labList/hResultOrg'

export default {
  name: "laboryOrgDataList",
